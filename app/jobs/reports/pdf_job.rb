...
# Overview of PDF generation process:
# - PDF generation combines the header, footer, and body using predefined templates located at @app/views/reports/templates/
# - Number of cover pages should be specified in the first line comment in cover.html.erb (e.g. <!-- cover_pages_count:1 -->)
# - Margins can be defined in the first line comment in header.html.erb (e.g. <!-- margins: top:3.5cm, right:1.5cm, bottom:3.5cm, left:1cm -->)
